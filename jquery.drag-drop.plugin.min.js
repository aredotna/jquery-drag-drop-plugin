...
.elementFromPoint(l-document.documentElement.scrollLeft-document.body.scrollLeft,c-document.documentElement.scrollTop-document.body.scrollTop);r.css("display",""),l-=s,c-=o,u&&(l=Math.min(Math.max(l,u.minX),u.maxX),c=Math.min(Math.max(c,u.minY),u.maxY)),r.css({left:l,top:c});if(h){if(i==null||i.get(0)!=h){var p=e(h);f.canDrop(p)?(f.dropClass&&(i!=null&&i.removeClass(f.dropClass),p.addClass(f.dropClass)),f.canDropClass&&r.addClass(f.canDropClass),i=p):i!=null&&a(f)}}else i!=null&&a(f);return t.stopPropagation(),!1},onEnd:function(t){if(!r)return;var s=t.data.source,o=s.data("options");i&&o.didDrop(n,i),a(o),o.makeClone?(r.remove(),o.sourceClass?n.removeClass(o.sourceClass):o.sourceHide&&n.css("visibility","visible")):(r.css("position","static"),r.css("width",""),r.css("height",""),o.dragClass&&r.removeClass(o.dragClass)),e(window).unbind("mousemove.dragdrop touchmove.dragdrop"),e(window).unbind("mouseup.dragdrop touchend.dragdrop"),n=r=u=null}};e.fn.dragdrop=function(t){if(f[t])return f[
t].apply(this,Array.prototype.slice.call(arguments,1));if(typeof t=="object"||!t)return f.init.apply(this,arguments);e.error("Method "+t+" does not exist on jQuery.dragdrop")}})(jQuery);